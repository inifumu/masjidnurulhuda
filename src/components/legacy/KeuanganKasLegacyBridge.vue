<!--
  Tujuan: Adapter sementara Stage 2 untuk menjaga kontrak legacy KeuanganKas tetap stabil saat swap bertahap.
  Caller: src/views/admin/KeuanganKas.vue
  Dependensi: src/composables/admin/useKas, src/stores/authStore, src/utils/permissions, komponen kas domain
  Main Functions: render summary kas, tab RBAC, dan delegasi konten tab ke komponen existing.
  Side Effects: Memicu loadData kas dan listener klik global untuk close dropdown selama lifecycle komponen.
-->
