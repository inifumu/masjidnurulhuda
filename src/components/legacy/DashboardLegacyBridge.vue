<!--
  Tujuan: Adapter sementara Stage 2 untuk menjaga kontrak legacy Dashboard tetap stabil saat swap bertahap.
  Caller: src/views/admin/Dashboard.vue
  ...
  Main Functions: render summary kas + period picker bulan/tahun dengan loading parity.
  Side Effects: Memicu fetch summary saat mount dan saat periode dashboard diganti.
-->
<script setup lang="ts">
import { useAuthStore } from "../../stores/authStore";
import { useDashboard } from "../../composables/admin/useDashboard";
import MonthYearPicker from "../admin/shared/MonthYearPicker.vue";
import {
  Wallet,
  TrendingUp,
  TrendingDown,
    ...
    >
      <div>
        ...
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Ringkasan keuangan Masjid Nurul Huda berdasarkan periode aktif.
        </p>
      </div>
