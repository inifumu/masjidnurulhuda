...
<template>
  ...
  <Sheet v-else-if="isMobile" :open="openMobile" @update:open="setOpenMobile">
    <SheetContent
      ...
      role="navigation"
      :side="side"
      class="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:size-11 [&>button_svg]:!size-5"
      :style="{
    ...
    >
      <SheetHeader class="sr-only">
        ...
        <SheetDescription>Menu ruang kerja pengurus Masjid Nurul Huda.</SheetDescription>
      </SheetHeader>
