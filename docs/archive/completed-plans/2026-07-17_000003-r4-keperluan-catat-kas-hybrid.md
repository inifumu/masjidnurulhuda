...
> **COMPLETED/HISTORICAL — RESET 2026-08-03:** Bukan planning/instruksi aktif. Gunakan `DESIGN.md`, `docs/ADMIN_REVAMP_PRD.md`, `ROADMAP.md`, dan `.hermes/plans/2026-08-03_013000-full-product-revamp-planning.md`. Fakta behavior/security/test di bawah hanya histori evidence.
