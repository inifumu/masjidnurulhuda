<!--
  Tujuan: Adapter sementara Stage 2 untuk menjaga kontrak legacy Pengaturan tetap stabil saat swap bertahap.
  Caller: src/views/admin/Pengaturan.vue
  Dependensi: src/composables/admin/usePengaturan, komponen tab pengaturan, ConfirmModal, lucide-vue-next
  Main Functions: render tab manajemen kategori/seksi/akun, modal form CRUD, dan dialog konfirmasi hapus.
  Side Effects: Registrasi listener klik global untuk sinkronisasi state dropdown selama lifecycle komponen.
-->
...
import TabKategori from "../admin/pengaturan/TabKategori.vue";
import TabSeksi from "../admin/pengaturan/TabSeksi.vue";
import TabAkun from "../admin/pengaturan/TabAkun.vue";
